export class CarBlueprint {
  ...
  getEngine() {
    return this.engine; //toto mi vraci hodnotu a yaroven returt se jiy neprovadi zadne prikazy, je to finalni krok netody.
  }
}
